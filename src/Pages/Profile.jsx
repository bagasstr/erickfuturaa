    ...
    <>
      ...
      <div className="h-[50rem]">
        ...
        <div className="w-full">
          <div className="bg-white shadow-lg absolute mx-auto px-4 pt-16 pb-10 rounded-md flex flex-col items-center left-0 right-0 top-60 w-[70rem] mobile:w-[22rem] mobile:px-2">
